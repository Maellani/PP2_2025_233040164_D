...
public class MahasiswaView extends JFrame {
    ...
    public MahasiswaView() {
        ...
        btnSimpan.addActionListener(e -> controller.handleSimpan());
        btnEdit.addActionListener(e -> controller.handleUbah());
        btnHapus.addActionListener(e -> controller.handleHapus());
        btnClear.addActionListener(e -> controller.handleClear());
        btnCari.addActionListener(e -> controller.handleCari());
